...
Most of these come down to network reality or how censusgeocoder serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

censusgeocoder rate-limits like any public site. geocoder already paces
...
Where a surface is gated, geocoder reads a cookie or token you supply
...
`geocoder`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what geocoder actually did
