...
```
geocoder <command> [arguments] [flags]
```

Run `geocoder <command> --help` for the full flag list on any command. This
...
per operation you declare in `censusgeocoder/domain.go`.
